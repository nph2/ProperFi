  ...
  return (
    <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY}`}>
      <div className={`flex-1 flex justify-start items-start flex-col xl:px-0 sm:px-16 px-6`}>
        ...
        <div className="flex flex-row justify-between items-center w-full">
          <h1 className="flex-1 font-poppins font-semibold ss:text-[72px] text-[52px] text-white ss:leading-[100px] leading-[75px]">
            Redifining  <br className="sm:block hidden"/> {" "}
        ...
        <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
          Invest as little as $5 in historically the most stable and profitable asset class - luxury real estate. 
          <br></br>
      ...
      <div className={`flex ${styles.flexCenter} relative`}>
        <img src={robot} className="w-[200%] h-[100%] relative z-[1] rounded-xl" alt="" srcset="" />
